#ifndef NLSSOLVER_IMPL_HPP_
#define NLSSOLVER_IMPL_HPP_
...
template <int D, typename T>
inline const double& NLLSSolver<D, T>::getChi2() const
{
    return chi2_;
}

template <int D, typename T>
inline const Matrix<double, D, D>& NLLSSolver<D, T>::getInformationMatrix() const
{
    return H_;
}
