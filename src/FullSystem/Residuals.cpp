 ...
 * 初始化点与帧的残差
 */
PointFrameResidual::PointFrameResidual(std::shared_ptr<PointHessian> point_, std::shared_ptr<FrameHessian> host_, std::shared_ptr<FrameHessian> target_) :
	point(point_),
	host(host_),
	target(target_)
{
...
/**
 * [PointFrameResidual::debugPlot description]
 */
