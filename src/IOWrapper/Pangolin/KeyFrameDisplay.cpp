 ...
 *
 * @param[in]  canRefresh  Indicates if refresh
 * @param[in]  scaledTH    The scaled th
 * @param[in]  absTH       The abs th
 * @param[in]  mode        The mode
 * @param[in]  minBS       The minimum bs
 * @param[in]  sparsity    The sparsity
 *
