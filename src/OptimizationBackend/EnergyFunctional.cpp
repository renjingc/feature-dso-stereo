...
/**
 * @brief      Sets the adjoints f.
 *
 * @param      Hcalib  The hcalib
 */
 ...
 * @param[in]  MT    { parameter_description }
 */
 ...
 * @brief      { function_description }
 *
 * @param[in]  xc     { parameter_description }
 * @param      xAd    The x ad
...
/**
 * @brief      Calculates the m energy f.
 *
 * @return     The m energy f.
 */
...
/**
 * @brief      Calculates the l energy point.
 *
 * @param[in]  min    The minimum
 * @param[in]  max    The maximum
 * @param      stats  The statistics
...
/**
 * @brief      Calculates the l energy f mt.
 *
 * @return     The l energy f mt.
 */
 ...
 * @brief      { function_description }
 *
 * @param      fh      { parameter_description }
 * @param      Hcalib  The hcalib
 *
 * @return     { description_of_the_return_value }
 */
...
/**
 * @brief      Gets the stitched delta f.
 *
 * @return     The stitched delta f.
 */
