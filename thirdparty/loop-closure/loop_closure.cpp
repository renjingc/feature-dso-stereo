...
LoopClosure::LoopClosure(const char *_voc_file, int _image_w, int _image_h, float _alpha)
:demo(_voc_file,_image_w, _image_h, _alpha), IMAGE_W(_image_w), IMAGE_H(_image_h)
{
